...
TOOL_REGISTRY: dict[str, dict[str, Any]] = {
    "ServiceCall": {"category": "device", "desc": "Call a Home Assistant service to control devices. Params: domain (for example light), service (for example turn_on), data (for example {entity_id:'light.xxx',brightness:255})", "priority": 1},
    ...
    "ConfigEntries": {"category": "system", "desc": "Manage Home Assistant integrations/config entries using frontend-like config-entry and flow APIs. Params: action (integration/descriptions, config_entries/get, config_entries/get_single, config_entries/update, config_entries/disable, config_entries/delete, config_entries/reload, config_entries/flow_handlers, config_entries/flow/progress, config_entries/flow/init, config_entries/flow/get, config_entries/flow/configure, config_entries/flow/abort, config_entries/ignore_flow, config_entries/options/init, config_entries/options/get, config_entries/options/configure, config_entries/options/abort), params", "priority": 3},
    "HAControl": {"category": "system", "desc": "Advanced Home Assistant control + host shell. Params: action (shell/check_config/list_integrations/get_integration/list_entities_by_integration/reload_integration/rename_entry/reload_themes/reload_resources/reload_scripts/reload_automations), params (e.g. {command, timeout, cwd} for shell; {domain} for integration actions)", "priority": 3},
